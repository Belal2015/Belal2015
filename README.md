...
- 🚀 Passionate about building reliable, scalable infrastructure and automating everything I can.
- 🌱 Always learning: **AWS**, **Docker**, **Kubernetes**, **CI/CD**, and more.
- 🧠 Love solving real-world tech challenges and simulating production systems.
- 🎯 On a mission to become a top-tier **Cloud & DevOps Engineer**.
- 📚 Consistency, curiosity, and continuous improvement are my superpowers.
...
<ul>
  ...
  <li>Learning advanced Kubernetes and cloud security</li>
  <li>Connecting with awesome people in tech</li>
</ul>
